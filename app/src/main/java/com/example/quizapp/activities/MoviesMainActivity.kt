...
class MoviesMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ivBack.setOnClickListener{
            val intent = Intent(this@MoviesMainActivity,QuizSelection::class.java)
        ...
        btnStart.setOnClickListener{
            if(etName.text.isEmpty()){
                ...
                val intent = Intent(this,MoviesQuestionsActivity::class.java)
                intent.putExtra(MoviesConstant.USER_NAME,etName.text.toString())
                startActivity(intent)
                finish()
            }
        }
