...
class ScienceNatureMainActivity : AppCompatActivity() {
    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_science_nature_main)
        val ivBack : ImageView = findViewById(R.id.iv_back)
        ivBack.setOnClickListener{
            val intent = Intent(this@ScienceNatureMainActivity,QuizSelection::class.java)
        ...
        btnStart.setOnClickListener{
            if(etName.text.isEmpty()){
                ...
                intent.putExtra(ScienceNature.USER_NAME,etName.text.toString())
                startActivity(intent)
                finish()
            }
        }
