...
class ScienceNatureQuestionsActivity : AppCompatActivity(),View.OnClickListener {
    ...
    private var mQuestionsList: ArrayList<ScienceQuestions>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_science_nature_questions)
        // check internet connection
        if (!NetworkUtil.isConnectedToInternet(this)) {
            // Redirect to NoInternetActivity if no internet is available
            val intent = Intent(this,ScienceNatureNoInternetActivity::class.java)
        ...
        mUserName = intent.getStringExtra(ScienceNature.USER_NAME)
        ...
        mQuestionsList = ScienceNature.getScienceQuestions()
        // END
            ...
            R.id.btn_submit ->{
                if(buttonSubmit?.text == "SUBMIT") {
                    ...
                    if (mCurrentPosition <= mQuestionsList!!.size) {
                        ...
                        val intent = Intent(this, ScienceNatureResultActivity::class.java)
                        intent.putExtra(ScienceNature.USER_NAME, mUserName)
                        intent.putExtra(ScienceNature.CORRECT_ANSWERS, mCorrectAnswers)
                        intent.putExtra(ScienceNature.TOTAL_QUESTIONS, mQuestionsList?.size)
                        startActivity(intent)
                        finish()
                    }
                }
        ...
        when (answer) {
            ...
            1 -> {
                tvOptionOne?.background = ContextCompat.getDrawable(
                    this@ScienceNatureQuestionsActivity,
                    drawableView
                )
            }
            2 -> {
    ...
    private fun customDialogForBackButton(){
        ...
        dialogBinding.btnYes.setOnClickListener {
            val intent = Intent(this@ScienceNatureQuestionsActivity,ScienceNatureMainActivity::class.java)
            startActivity(intent)
            finish()
