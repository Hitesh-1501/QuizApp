...
class SportsQuestionActivity : AppCompatActivity(),View.OnClickListener {
    ...
    private var mQuestionsList: ArrayList<SportsQuestions>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sports_question)
        // check internet connection
        if (!NetworkUtil.isConnectedToInternet(this)) {
            // Redirect to NoInternetActivity if no internet is available
            val intent = Intent(this,SportsNoIntenetActivity::class.java)
        ...
        mUserName = intent.getStringExtra(SportsConstants.USER_NAME)
        ...
        mQuestionsList = SportsConstants.sportsGetQuestions()
        // END
            ...
            R.id.btn_submit ->{
                if(buttonSubmit?.text == "SUBMIT") {
                    ...
                    if (mCurrentPosition <= mQuestionsList!!.size) {
                        ...
                        intent.putExtra(SportsConstants.USER_NAME, mUserName)
    ...
    private fun customDialogForBackButton(){
        ...
        dialogBinding.btnYes.setOnClickListener {
            val intent = Intent(this@SportsQuestionActivity,SportsMainActivity::class.java)
            startActivity(intent)
            finish()
