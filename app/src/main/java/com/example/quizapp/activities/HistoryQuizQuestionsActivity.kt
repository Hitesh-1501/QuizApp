...
class HistoryQuizQuestionsActivity : AppCompatActivity(),View.OnClickListener {
    ...
    private var mQuestionsList: ArrayList<HistoryModel>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_history_quiz_questions)
        // check internet connection
        if (!NetworkUtil.isConnectedToInternet(this)) {
            // Redirect to NoInternetActivity if no internet is available
            val intent = Intent(this, HistoryNoInternetActivity::class.java)
        ...
        mUserName = intent.getStringExtra(HistoryConstants.USER_NAME)
        ...
        mQuestionsList = HistoryConstants.historyGetQuestions()
        // END
            ...
            R.id.btn_submit ->{
                if(buttonSubmit?.text == "SUBMIT"){
                    ...
                    if (mCurrentPosition <= mQuestionsList!!.size) {
                        ...
                        intent.putExtra(HistoryConstants.USER_NAME, mUserName)
                        intent.putExtra(HistoryConstants.CORRECT_ANSWERS, mCorrectAnswers)
                        intent.putExtra(HistoryConstants.TOTAL_QUESTIONS, mQuestionsList?.size)
                        startActivity(intent)
                        finish()
                    }
                }
        ...
        when (answer) {
            ...
            1 -> {
                tvOptionOne?.background = ContextCompat.getDrawable(
                    this@HistoryQuizQuestionsActivity,
                    drawableView
                )
            }
            2 -> {
    ...
    private fun customDialogForBackButton(){
        ...
        dialogBinding.btnYes.setOnClickListener {
            val intent = Intent(this@HistoryQuizQuestionsActivity,HistoryMainActivity::class.java)
            startActivity(intent)
            finish()
