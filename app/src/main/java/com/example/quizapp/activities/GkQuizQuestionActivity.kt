...
class GkQuizQuestionActivity : AppCompatActivity(),View.OnClickListener {
    ...
    private var mQuestionsList: ArrayList<GkQuestions>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_gk_quiz_question)

        // check internet connection
        if (!NetworkUtil.isConnectedToInternet(this)) {
            // Redirect to NoInternetActivity if no internet is available
            val intent = Intent(this, GkNoInternetQuestionActivity::class.java)
        ...
        mUserName = intent.getStringExtra(GkConstants.USER_NAME)
        ...
        mQuestionsList = GkConstants.getGkQuestions()
        // END
            ...
            R.id.btn_submit ->{
                if(buttonSubmit?.text == "SUBMIT") {
                    ...
                    if (mCurrentPosition <= mQuestionsList!!.size) {
                        ...
                        val intent = Intent(this, GkResultActivity::class.java)
                        intent.putExtra(GkConstants.USER_NAME, mUserName)
                        intent.putExtra(GkConstants.CORRECT_ANSWERS, mCorrectAnswers)
                        intent.putExtra(GkConstants.TOTAL_QUESTIONS, mQuestionsList?.size)
                        startActivity(intent)
                        finish()
                    }
                }
    ...
    private fun customDialogForBackButton(){
        ...
        dialogBinding.btnYes.setOnClickListener {
            val intent = Intent(this@GkQuizQuestionActivity,GeneralKnowledgeQuiz::class.java)
            startActivity(intent)
            finish()
