...
class HistoryMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ivBack.setOnClickListener{
            val intent = Intent(this@HistoryMainActivity,QuizSelection::class.java)
        ...
        btnStart.setOnClickListener{
            if(etName.text.isEmpty()){
                ...
                val intent = Intent(this,HistoryQuizQuestionsActivity::class.java)
                intent.putExtra(HistoryConstants.USER_NAME,etName.text.toString())
                startActivity(intent)
                finish()
            }
        }
